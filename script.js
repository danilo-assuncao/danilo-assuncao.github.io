...
const STORY_PARTS = [
  "Desde 18 de outubro, o meu tempo mudou.\nNão o relógio, não os dias… mas o jeito que eu sinto tudo passar.",
  "Antes, o tempo era só tempo.\nAgora ele faz tic… tac…\nE, de alguma forma, cada segundo sempre acaba em você.",
  "É engraçado como a gente inventou um jeito de se reconhecer sem usar nomes.\nComo se “tic tac” fosse o nosso idioma secreto.\nNosso código.\nNosso jeito silencioso de dizer “é você”.",
  "Quando eu penso em você, eu sinto calma.\nSinto casa.\nE percebo que não quero correr contra o tempo, nem apressar nada.\nEu só quero viver cada segundo ao seu lado.",
